...
function revalidateAgreementTargets(input: {
  ...
  if (input.id) {
    revalidatePath(`/admin/agreements/${input.id}`);
    revalidatePath(`/admin/agreements/${input.id}/pdf`);
  }
  if (input.proposalId) {
    revalidatePath(`/admin/proposals/${input.proposalId}`);
    revalidatePath(`/admin/proposals/${input.proposalId}/pdf`);
  }
