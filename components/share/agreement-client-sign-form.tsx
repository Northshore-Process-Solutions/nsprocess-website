...
export function AgreementClientSignForm({
  ...
  if (alreadySigned) {
    return (
      <section className="mx-auto mt-8 max-w-[8.5in] rounded-2xl border border-emerald-200 bg-emerald-50 p-6 shadow-soft">
  ...
  return (
    <section className="mx-auto mt-8 max-w-[8.5in] rounded-2xl border border-border bg-card p-6 shadow-soft">
      <h2 className="text-lg font-semibold text-slate-900">Sign this agreement</h2>
